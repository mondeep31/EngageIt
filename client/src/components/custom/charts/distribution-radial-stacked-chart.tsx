...
export function DistributionRadialStackedChart({
  ...
  return (
    <Card className="relative p-5 shadow-sm min-w-80 xl:min-w-0">
      {isShowTitle && (
        <span className="text-base/5 font-semibold text-black">Donut</span>
      )}

      {isShowHeader && (
        <div className="flex items-start justify-between">
          <div className="space-y-2.5 font-semibold">
            <p className="text-[10px]/none uppercase">Sales Distribution</p>
      ...
      <CardContent>
        ...
        <div className="relative z-10 -mt-10 flex flex-wrap place-items-center justify-center gap-x-8 gap-y-5 xl:gap-5 p-4 font-semibold xl:grid sm:grid-cols-3">
          <div className="relative pl-2.5 pr-1.5">
            ...
            <p className="mt-1.5 text-lg/tight text-black">$15,800</p>
          </div>
          <div className="relative pl-2.5 pr-1.5">
            ...
            <p className="mt-1.5 text-lg/tight text-black">$8,074</p>
          </div>
          <div className="relative pl-2.5 pr-1.5">
            ...
            <p className="mt-1.5 text-lg/tight text-black">$3,150</p>
          </div>
        </div>
      </CardContent>
    </Card>
